...
(function(){
  ...
  const ACTS = {
    18:[
      ...
      { from:'11:30', to:'12:30', ic:'🍜', state:'도쿄 입성!', sub:'닛포리 도착 · 점심 · 짐 맡기기' },
      { from:'12:30', to:'14:30', ic:'🏮', state:'아사쿠사', sub:'센소지 · 나카미세' },
      { from:'14:30', to:'16:30', ic:'🏠', state:'숙소 체크인', sub:'앨리스 도쿄 스테이 · 3박 4일 시작' },
      { from:'16:30', to:'23:59', ic:'🎮', state:'아키하바라', sub:'전자상가 · 저녁' },
    ],
    19:[
      { from:'00:00', to:'08:00', ic:'🛏️', state:'수면 중', sub:'에노시마 멀어서 8시 기상 권장' },
      { from:'08:00', to:'15:00', ic:'🏖️', state:'에노시마·가마쿠라', sub:'섬 입장 · 슬램덩크 건널목' },
      { from:'15:00', to:'23:59', ic:'🛍️', state:'시부야 쇼핑', sub:'PARCO 등 · 저녁' },
    ],
    20:[
      { from:'00:00', to:'08:00', ic:'🛏️', state:'수면 중', sub:'3일차 밤' },
      { from:'08:00', to:'15:30', ic:'🎭', state:'아코스타', sub:'사이타마 코스프레 · 점심' },
      { from:'15:30', to:'23:59', ic:'🌐', state:'팀랩 플래닛', sub:'도요스 · 17시 입장 · 저녁' },
    ],
    21:[
      { from:'00:00', to:'08:00', ic:'🛏️', state:'마지막 밤', sub:'오늘 귀국이에요' },
      { from:'08:00', to:'10:00', ic:'🧳', state:'체크아웃·짐 보관', sub:'닛포리역 락커 (일찍 확보)' },
      { from:'10:00', to:'14:15', ic:'🛍️', state:'긴자·도쿄역 쇼핑', sub:'짐 없이 가볍게 · 점심' },
      { from:'14:15', to:'16:00', ic:'🚆', state:'나리타 이동 중', sub:'짐 회수 → 스카이라이너 → 16:00 나리타' },
      { from:'16:00', to:'18:00', ic:'🎫', state:'출국 수속', sub:'체크인·보안·출국 (버퍼 ~2h25m)' },
  ...
  const SCHED = {
    18:{t:'도착일 · 아사쿠사·아키하바라', s:'스카이라이너로 닛포리 → 15:00 체크인'},
    19:{t:'에노시마 · 가마쿠라 · 시부야', s:'섬+슬램덩크 건널목 → 시부야 쇼핑'},
    20:{t:'아코스타 · 팀랩 플래닛', s:'사이타마 코스프레 → 도요스 팀랩'},
    21:{t:'귀국일 · 긴자 쇼핑',    s:'닛포리 락커 → 16:00 나리타 → 18:25 출발'},
  };
